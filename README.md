...
Use GitHub Issues to report bugs, request features, or share compatibility
notes:

https://github.com/Leask/UNAS-Access-Public/issues

When filing an issue, include:

- App version and build number.
- Platform and OS version.
- Connection mode, such as local UNAS URL or UniFi account remote access.
- A short description of what you expected and what happened instead.
- Screenshots or logs when they help explain the problem.

Do not include passwords, API keys, session cookies, private access tokens, or
